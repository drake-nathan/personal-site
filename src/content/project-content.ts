export const projects = [
  {
    title: 'Slackers - Group Project',
    link: 'https://slackersz.netlify.app',
  ...
  {
    title: 'Hyzer Ninja - Capstone Project',
    description: ['Disc golf app.'],
    image: '/images/slackers.png',
  },
  {
    title: 'Stand With Ukraine - Pair Project',
    description: [],
  },
];
